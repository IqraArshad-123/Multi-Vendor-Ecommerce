  ...
  return (
    <>
      ...
      >
        ...
        {/* header sidebar */}
        {open && (
          <div className="fixed w-full z-20 h-full top-0 bg-[#0000005f] left-0">
            <div className="fixed w-[60%] top-0 h-screen left-0 z-20 bg-[#fff] overflow-y-scroll">
                  ...
                  <div>
                    <Link to="/profile">
                      <img
                        src={`${backend_url}${user.avatar}`}
                        alt=""
                        className="w-[60px] h-[60px] rounded-full border-[3px] border-[#03cb8c]"
                      />
                    </Link>
                  </div>
                ) : (
